...
/*
Related Files:
page-my-notes.php  contains the id #my-notes 
*/
var MyNotes =
/*#__PURE__*/
function () {
  function MyNotes() {
    ...
    this.newForm = (0, _jquery.default)('#newForm');
  }

  _createClass(MyNotes, [{
    key: "events",
    value: function events() {
      (0, _jquery.default)("#toggleNewForm").on("click", this.toggleNew.bind(this));
      (0, _jquery.default)("#placeholderDataBtn").on("click", this.placeholderData.bind(this));
    ...
    key: "placeholderData",
    value: function placeholderData(e) {
